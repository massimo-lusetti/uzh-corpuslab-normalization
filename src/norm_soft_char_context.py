...
#            self.bbuffRNN_cont  = dy.CoupledLSTMBuilder(self.hyperparams['LAYERS'], 4*self.hyperparams['HIDDEN_DIM']+self.hyperparams['INPUT_DIM_WORD'], self.hyperparams['HIDDEN_DIM_CONTEXT'], pc)
            self.fbuffRNN_cont  = dy.CoupledLSTMBuilder(self.hyperparams['LAYERS'], 4*self.hyperparams['HIDDEN_DIM'], self.hyperparams['HIDDEN_DIM_CONTEXT'], pc)
            self.bbuffRNN_cont  = dy.CoupledLSTMBuilder(self.hyperparams['LAYERS'], 4*self.hyperparams['HIDDEN_DIM'], self.hyperparams['HIDDEN_DIM_CONTEXT'], pc)
...
#            input_emb_context.append(dy.concatenate([word_embedding, word_char_encoding[0], word_char_encoding[-1]]))
            input_emb_context.append(dy.concatenate([word_char_encoding[0], word_char_encoding[-1]]))
